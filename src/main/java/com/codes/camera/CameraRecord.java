...
public class CameraRecord extends Activity implements Callback{
    ...
    private final static String TAG = "CameraRecord";
	...
	private File f2;
		 ...
		 if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
			 if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED &&
				 ...
				 if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.CAMERA)) {
					 ...
					 ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.CAMERA, Manifest.permission.RECORD_AUDIO, Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_VIDEO_CAPTURE);
				 }
			 }
		 }
		 else {
	 ...
	 protected void startRecording() throws IOException
	    {
			...
			//Crea la carpeta
			File folder = new File("/sdcard/All/");
			if(!folder.exists())
				folder.mkdirs();
			...
			Date date = new Date();			
			videoRoute = Environment.getExternalStorageDirectory().getPath() + "/All/video_" +dateFormat.format(date).toString() +".mp4";
	    ...
	    protected void stopRecording() {    	
	        ...
	        if(mediaRecorder!=null && flagMediaRecorder == true)
	        {
				...
				Toast.makeText(this, "Vídeo guardado en: "+videoRoute, Toast.LENGTH_LONG);
	    		finish();
	        }
	 ...
	 public int setCameraDisplayOrientation() {
	        ...
	        Camera.getCameraInfo(presentCamera, info);
	...
	public void onBackPressed() {
		...
		if(recording == true) {
			...
			builder.setTitle("Aviso")
					.setMessage("Si sale de la pantalla de grabación, el vídeo no será guardado")
